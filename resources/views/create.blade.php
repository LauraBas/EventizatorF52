        ...
        <div class="box-border p-4 bg-white h-128 w-96">
            <form action="{{route('store')}}" method="POST">
                ...
                <div class="mt-4">
                    ...
                    <input id="title" class="block mt-1 w-full bg-gray-200 border-gray-200 rounded-lg" type="text" name="title" value="title"/>
                </div>
                <div class="mt-4">
                    <label for="date" value="__('Date')"/>
                    <input id="date" class="block mt-1 w-full bg-gray-200 border-gray-200 rounded-lg" type="date" name="date" value="date"/>
                </div>
                <div class="mt-4">
                    <label for="Time" value="__('Time')"/>

                    <input id="time" class="block mt-1 w-full bg-gray-200 border-gray-200 rounded-lg" type="time" name="time" value="time"/>
                </div>
                <div class="mt-4">
                ...
                <div class="mt-4">
                    ...
                    <input id="image" class="block mt-1 w-full bg-gray-200 border-gray-200 rounded-lg" type="text" name="image" value="image"/>
                </div>
                <div class="mt-4">
                    <label for="link" value="__('Link')"/>

                    <input id="link" class="block mt-1 w-full bg-gray-200 border-gray-200 rounded-lg" type="text" name="link" value="{{link}}"/>
                </div>
